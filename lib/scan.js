...
export const start = async () => {
    ...
    for (const folder of folders) {
        if (completedFolders.includes(folder.artist)) continue;
        completedFolders.push(folder.artist);
        ...
        for (const mediaPart of media) {
            ...
            console.log(id, title, releaseYear, type, mediaPart);
            ...
            const folderName = `${title.substring(0, 40)} (${releaseYear}) - ${
